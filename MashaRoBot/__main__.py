...
PM_START_TEXT = """
Hello I'm 𝕭𝖊𝖘𝖙𝖎𝖊𝖘 𝕽𝖔𝖇𝖔𝖙 ,
༒︎ I ᴀᴍ ᴍᴜʟᴛɪ ᴛᴀʟᴇɴᴛᴇᴅ ʙᴏᴛ ᴡɪᴛʜ ᴏsᴍ ғᴇᴀᴛᴜʀᴇs[.](https://telegra.ph/file/02b04696a7d8b49948d58.jpg)

➪ ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴀɴᴅ ᴍᴀᴋᴇ ᴀᴅᴍɪɴ ᴛᴏ ᴍᴀɴᴀɢᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴡɪᴛʜ ᴇxᴘʟᴏsɪᴠᴇ.

➪ ᴄᴏɴᴛᴀᴄᴛ ᴍʏ [ᴍᴀsᴛᴇʀ](t.me/SEMXY_ELITEBOY) ғᴏʀ ᴀɴʏ ǫᴜᴇʀʏ ᴀɴᴅ [ᴀᴘᴘᴇᴀʟ](https://t.me/BESTIES_0P) ʜᴇʀᴇ.
...
buttons = [
    [
        InlineKeyboardButton(
            text="➕️ 𝐀𝐝𝐝 𝐁𝐞𝐬𝐭𝐢𝐞𝐬 𝐓𝐨 𝐘𝐨𝐮𝐫 𝐆𝐫𝐨𝐮𝐩 ➕️", url="t.me/BESTIES_OP_BOT?startgroup=true"),
    ],
    [
    ...
    [
        InlineKeyboardButton(
            text="✨𝐁𝐞𝐬𝐭𝐢𝐞𝐬 𝐋𝐨𝐠𝐬✨", url="https://t.me/B3STIESLOGS"),
        InlineKeyboardButton(
            text="👥𝐒𝐮𝐩𝐩𝐨𝐫𝐭👥", url="https://t.me/BESTIES_OFFICIAL"),
    ],
    [
        InlineKeyboardButton(text="❤️𝐃𝐩𝐬 𝐁𝐠𝐬❤️", url="https://t.me/ELITES_DPS_BGZ"
    ), 
    ],
    [   
...
def Masha_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "masha_":
        query.message.edit_text(
            text=""" ℹ️ I'm *𝕭𝖊𝖘𝖙𝖎𝖊𝖘*, a powerful group management bot built to help you manage your group easily.
                 ...
                 Here is the [𝕯𝖊𝖛𝖊𝖑𝖔𝖕𝖊𝖗](t.me/TUSHAR204).
